...
const fieldBase =
  "w-full rounded-lg border border-line bg-asphalt/60 px-4 py-2.5 text-bone placeholder:text-concrete/60 outline-none transition focus:border-ignition/60 focus:ring-2 focus:ring-flare/30"
